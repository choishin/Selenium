	...
	static void ReadData() throws IOException {
		...
		try {
			...
			for (int iRow = 1; iRow <= rowsCnt; iRow++) {
				...
				Thread.sleep(2000);
				String city_name = driver.findElement(By.xpath("/html/body/form/div[2]/div[5]/div[4]/div[5]/div[1]/table/tbody/tr["+iRow+"]/td[1]")).getText().replace(",","").replace(" ","");			
				String city_population = driver.findElement(By.xpath("/html/body/form/div[2]/div[5]/div[4]/div[5]/div[1]/table/tbody/tr["+iRow+"]/td[2]")).getText().replace(",","").replace(" ","");			
